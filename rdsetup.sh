...
# source /home/user/catkin_ws/src/rtabrw/rdsetup.sh
...
#
alias rlu="roslaunch rtabrw udacity_world.launch" #
alias rla="roslaunch rtabrw amcl.launch" #
alias rlz="roslaunch rtabrw rviz.launch" #
alias rlg="roslaunch rtabrw gui.launch" #
